...
spec.homepage     = "https://github.com/shuftipro/Shufti-Sadad"
...
spec.source       = { :git => "https://github.com/shuftipro/Shufti-Sadad.git", :tag => "#{spec.version}" }
